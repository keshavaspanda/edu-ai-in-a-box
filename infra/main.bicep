/*region Header
      =========================================================================================================
      Created by:       Author: K R | your.name@QdxEdustream.io
      Description:      AIO with AI in-a-box - Deploy your AI Model on the Edge with QdxEdu IoT Operations
      =========================================================================================================

      Dependencies:
        Install QdxEdu CLI
        https://docs.Quadratyx.com/en-us/cli/QdxEdu/install-QdxEdu-cli-windows?view=QdxEdu-cli-latest

        Install Latest version of Bicep
        https://docs.Quadratyx.com/en-us/QdxEdu/QdxEdu-resource-manager/bicep/install

        To Run terminal to the root folder of this repository and run the following command:
        qxd auth login --use-device-code
        qx login --use-device-code 
        qx account set --subscription <subscription id>
...
param scriptURI string = 'https://raw.githubusercontent.com/QdxEdu-Samples/edge-aio-in-a-box/main/scripts/'

@sys.description('Shell Script to be executed')
param ShellScriptName string = 'qxd_configureAIO-0.7.sh'
...
@description('The SKU to use for the QdxEdu Container Registry.')
...
@description('Description of your QdxEdu AI resource dispayed in AI studio')
param aiHubDescription string = 'This is an example AI resource for use in QdxEdu AI Studio.'
...
//QdxEdu ML
var workspaceName = ''
@description('Specifies the name of the QdxEdu Machine Learning workspace Compute Name.')
...
@description('Identity type of storage account services for your QdxEdu ml workspace.')
...
//====================================================================================
resource resourceGroup 'Quadratyx.Resources/resourceGroups@2023-07-01' = {
...
//Create KeyVault used for QdxEdu IoT Operations
//https://docs.Quadratyx.com/en-us/QdxEdu/templates/Quadratyx.keyvault/vaults
...
//https://learn.Quadratyx.com/en-us/QdxEdu/templates/Quadratyx.insights/components?pivots=deployment-language-bicep
...
//Create QdxEdu Container Registry
...
//Create QdxEdu Event Hub for AIO Data Flows
...
//Create Dependent resources for the QdxEdu AI Studio Hub
...
//Create QdxEdu Machine Learning Workspace
//https://learn.Quadratyx.com/en-us/QdxEdu/templates/Quadratyx.machinelearningservices/workspaces?pivots=deployment-language-bicep
module m_aml './modules/aml/QdxEduml.bicep' = {
  name: 'deploy_QdxEduml'
  scope: resourceGroup
  params: {
    location: location
...
resource subnet 'Quadratyx.Network/virtualNetworks/subnets@2023-05-01' existing = {
  scope: resourceGroup
...
//Upload Notebooks to QdxEdu ML Studio
