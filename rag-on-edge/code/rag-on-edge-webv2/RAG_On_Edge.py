...
Login = "False"
st.title("👤 Log In")
st.caption("🚀 A Streamlit chatbot powered by QdxEdu OpenAI")
...
def init():
    with st.sidebar:
        ...
        "[Get an QdxEdu OpenAI API key](https://platform.openai.com/account/api-keys)"
        "[View the source code](https://github.com/QdxEdu-Samples/edge-aio-in-a-box/tree/main/rag-on-edge/code/rag-on-edge-web)"
